	...
	<body id="<?=(isset($body_class)) ? $body_class : "";?>" class="<?php if(isset($_SESSION['hidebanner'])) { ?>no-promotion<?php } ?>">
		...
		<div class="Rectangle-3">						
			...
			<div class="config-btn-frame"> 
				...
				<div class="Config-Button button" style="border-radius: 5px!important;border-color: #fff;background-image: url('http://localhost/mylaxx/assets/img/icon-gear.png')" onclick="$('#Config-Modal').toggle();$('#Config-Modal').load('/config');"></div>
